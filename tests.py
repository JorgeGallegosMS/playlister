...
sample_playlist = {
    ...
    'description': 'Highlights for each game',
    'videos': [
        'https://www.youtube.com/embed/C7kjHcjkwr0',
        'https://www.youtube.com/embed/zcnpuqYHKXI'
    ]
}
sample_form_data = {
...
class PlaylistsTests(TestCase):
    ...
    def test_show_playlist(self, mock_find):
        ...
        self.assertEqual(result.status, '200 OK')
        self.assertIn(b'NFL Highlights', result.data)
